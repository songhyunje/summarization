...
from src.triple_summary.configuration import DecoderConfig
from src.triple_summary.decoder import TransformerDecoder
...
class BertAbs(nn.Module):
    ...
    def forward(
        self, encoder_input_ids, decoder_input_ids, encoder_attention_mask,
    ):
