...
from src.common.dataset.dataset import TripleDataset
from src.common.tokenization.tokenization_kt import Tokenizer
from src.triple_summary.bertabs import BertAbs

logger = logging.getLogger(__name__)


class TripleSum(pl.LightningModule):
    def __init__(self, hparams):
        super(TripleSum, self).__init__()
    ...
    def add_model_specific_args(parser):
        ...
        # parser.add_argument("--lr", default=1e-2, type=float, help="The initial learning rate for decoder.")
        parser.add_argument("--encoder_lr", default=5e-5, type=float, help="The initial learning rate for encoder.")
        parser.add_argument("--decoder_lr", default=5e-2, type=float, help="The initial learning rate for decoder.")
        parser.add_argument("--weight_decay", default=0.1, type=float, help="Weight decay if we apply some.")
        parser.add_argument("--adam_epsilon", default=1e-8, type=float, help="Epsilon for Adam optimizer.")
        # parser.add_argument("--warmup", default=500, type=int, help="Linear warmup over warmup_steps.")
